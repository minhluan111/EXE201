...
export default function BookingConfirmPage() {
    ...
    return (
      <div style={{
        ...
        <motion.div 
          ...
          style={{
            textAlign: "center", maxWidth: 440, width: "100%", padding: "48px 32px",
            borderRadius: 32, background: "var(--bg-card)", border: "1.5px solid var(--border)",
            boxShadow: "var(--shadow-lg)"
          }}
        >
          <div style={{
            width: 64, height: 64, margin: "0 auto 24px", display: "flex", alignItems: "center", justifyContent: "center",
            borderRadius: "50%", background: "rgba(245,158,11,0.1)", border: "1px solid rgba(245,158,11,0.2)",
            color: "#F59E0B"
          }}>
            <AlertCircle size={28} />
          </div>
          <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 32, fontWeight: 700, marginBottom: 12, color: "var(--text)" }}>
            Trống Thông Tin
          </h2>
          <p style={{ color: "var(--text-muted)", fontSize: 15, marginBottom: 32, lineHeight: 1.6 }}>
            Hệ thống không tìm thấy thông tin bàn chỗ mà quý khách đã lựa chọn. Vui lòng quay lại trang đặt bàn.
          </p>
          <button
            onClick={() => nav("/booking")}
            style={{ 
              width: "100%", py: 16, padding: "16px", borderRadius: 50, fontWeight: 700, fontSize: 16,
              background: "linear-gradient(135deg, var(--matcha), var(--forest))", color: "#ffffff",
              border: "none", cursor: "pointer", boxShadow: "0 8px 24px rgba(107, 143, 62, 0.25)",
  ...
  const confirm = async () => {
    ...
    setMessage(`Đặt bàn thành công! Mã đặt bàn của quý khách là: ${res.data.reservation_code || res.data.id}`);
    clear();
  ...
  return (
    <div style={{ background: "var(--bg)", minHeight: "100vh", paddingBottom: 96, color: "var(--text)" }}>
        ...
        <div className="container-xl" style={{ padding: "0 24px" }}>
          ...
          >
            ...
            <p style={{ color: "var(--text-muted)", marginTop: 12, maxWidth: 640, margin: "12px auto 0", fontSize: 15, lineHeight: 1.6 }}>
              Vui lòng xem lại thông tin chi tiết phòng trà và điền các ghi chú đặc biệt để chúng tôi chuẩn bị đón tiếp quý khách một cách hoàn hảo nhất.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      {/* Main Grid content */}
      <div className="container-xl" style={{ padding: "0 24px", marginTop: 48 }}>
        <div className="confirm-layout">
          ...
          <motion.div
            ...
            style={{
              ...
              borderRadius: 24, padding: "32px 24px", boxShadow: "var(--shadow-md)"
            }}
          >
            <div style={{ display: "flex", alignItems: "center", gap: 14, pb: 16, borderBottom: "1.5px solid var(--border)", marginBottom: 28, paddingBottom: 16 }}>
              <div style={{
                width: 42, height: 42, display: "flex", alignItems: "center", justifyContext: "center", 
                borderRadius: 12, background: "rgba(107, 143, 62, 0.1)", color: "var(--matcha)",
                justifyContent: "center"
              }}>
                <Coffee size={20} />
              </div>
              <div>
                <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 24, fontWeight: 700, color: "var(--forest)", margin: 0 }}>
                  Thông Tin Phòng Trà
                </h2>
            ...
            <div className="details-grid">
              ...
              <div className="detail-item">
                ...
                <div>
                  ...
                  <span className="detail-value">{table?.area || "Chưa xác định"}</span>
                </div>
              </div>

              <div className="detail-item">
                <div className="detail-icon" style={{ background: "rgba(47, 91, 62, 0.1)", color: "var(--forest)" }}><Coffee size={16} /></div>
                <div>
                  <span className="detail-label">BÀN TRÀ</span>
                  <span className="detail-value" style={{ color: "var(--forest)", fontWeight: 700 }}>{table?.name || "Chưa xác định"}</span>
                </div>
              </div>
              ...
              <div className="detail-item full-width">
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <span className="detail-value" style={{ display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" }}>
            ...
            <div style={{ marginTop: 32, paddingTop: 24, borderTop: "1.5px solid var(--border)" }}>
              <label style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 14, fontWeight: 700, color: "var(--text)", marginBottom: 12 }}>
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              <div>
                ...
                <div style={{ position: "relative" }}>
                  <User size={16} style={{ position: "absolute", left: 16, top: "50%", transform: "translateY(-50%)", color: "var(--text-light)" }} />
                  <input type="text" disabled value={receiverName} className="confirm-input" />
                </div>
              </div>
              ...
              <div>
                ...
                <div style={{ position: "relative" }}>
                  <Phone size={16} style={{ position: "absolute", left: 16, top: "50%", transform: "translateY(-50%)", color: "var(--text-light)" }} />
                  <input type="text" disabled value={receiverPhone} className="confirm-input" />
                </div>
              </div>
              ...
              <div>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <input type="email" disabled value={receiverEmail} className="confirm-input" />
                </div>
              </div>
            </div>
            ...
            <div style={{
              marginTop: 24, padding: "16px 20px", borderRadius: 16, background: "rgba(14,165,233,0.05)",
              border: "1.5px solid rgba(14,165,233,0.1)", display: "flex", gap: 12, alignItems: "start"
            }}>
              <Info size={16} style={{ color: "#0EA5E9", flexShrink: 0, marginTop: 2 }} />
              <div style={{ fontSize: 12, lineHeight: 1.5, color: "#0284C7" }}>
                <p style={{ fontWeight: 700, margin: "0 0 2px" }}>Xác Thực Hệ Thống</p>
                <p style={{ margin: 0, opacity: 0.85 }}>Thông tin này được trích xuất an toàn từ tài khoản đã đăng nhập của quý khách để ghi nhận lịch đặt bàn.</p>
              </div>
            </div>
            ...
            <AnimatePresence>
              ...
              {message && (
                ...
                >
                  <div style={{
                    padding: "14px 18px", borderRadius: 16, background: "rgba(16,185,129,0.06)",
                    border: "1.5px solid rgba(16,185,129,0.15)", color: "#10B981", fontSize: 13,
                    display: "flex", gap: 10, alignItems: "center", fontWeight: 600
                  }}>
            ...
            <motion.button
              ...
              whileHover={!(loading || !!message) ? { y: -2, boxShadow: "0 10px 24px rgba(107, 143, 62, 0.3)" } : {}}
            ...
            >
              {loading ? (
                <span style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  <svg className="animate-spin" style={{ width: 18, height: 18, color: "#fff" }} fill="none" viewBox="0 0 24 24">
            ...
            <Link 
              ...
              onMouseOver={(e) => e.currentTarget.style.color = "var(--matcha)"}
