        ...
        <Container maxWidth="lg">
          ...
          >
            ...
            <Typography sx={{ opacity: 0.8 }}>
              Quản lý danh sách bàn, khu vực, và sức chứa
            </Typography>
          </motion.div>
        </Container>
      </Box>
          ...
          >
            ...
            >
              <CardContent sx={{ textAlign: "center", py: 12 }}>
                ...
                <Typography variant="h5">Tính Năng Quản Lý Bàn</Typography>
                <Typography sx={{ mt: 1, fontSize: "14px", opacity: 0.6 }}>
                  Đây là bản mock - chức năng quản lý bàn sẽ được triển khai
