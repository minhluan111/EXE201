        ...
        <Container maxWidth="lg">
          ...
          >
            ...
            <Typography sx={{ opacity: 0.8 }}>
              Xem và quản lý các đánh giá về menu từ khách hàng
            </Typography>
          </motion.div>
        </Container>
      </Box>
          ...
          >
            ...
            >
              <CardContent sx={{ textAlign: "center", py: 12 }}>
                ...
                <Typography variant="h5">Tính Năng Quản Lý Đánh Giá</Typography>
                <Typography sx={{ mt: 1, fontSize: "14px", opacity: 0.6 }}>
                  Đây là bản mock - chức năng quản lý đánh giá sẽ được triển
                  khai trong phiên bản tiếp theo
                </Typography>
              </CardContent>
            </Card>
          </motion.div>
