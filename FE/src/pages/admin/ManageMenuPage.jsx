...
const COCHIN_CATEGORIES = [
  { value: "Coffee",  label: "Cà phê & Sô cô la" },
  { value: "MilkTea", label: "Trà sữa" },
  { value: "Tea",     label: "Trà trái cây & Trà hoa" },
];
...
export default function ManageMenuPage() {
  ...
  const tenantCategories = isMonari ? MONARI_CATEGORIES : (isCochin ? COCHIN_CATEGORIES : ((isComTam || isMonQuanChat) ? COM_TAM_CATEGORIES : (isSamHouse ? SAM_HOUSE_CATEGORIES : (isHoaTeaRoom ? HOA_TEA_ROOM_CATEGORIES : MATCHA_CATEGORIES))));
