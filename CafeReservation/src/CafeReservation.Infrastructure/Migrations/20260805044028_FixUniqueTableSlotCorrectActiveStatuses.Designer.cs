...
namespace CafeReservation.Infrastructure.Migrations
{
    ...
    [Migration("20260805044028_FixUniqueTableSlotCorrectActiveStatuses")]
    partial class FixUniqueTableSlotCorrectActiveStatuses
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CafeReservation.Domain.Entities.Reservation", b =>
                {
                    ...
                    b.Property<string>("BookingPriority")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasColumnName("booking_priority");

                    b.Property<string>("BookingPriorityExplanation")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                        .HasColumnName("booking_priority_explanation");

                    b.Property<string>("BookingPriorityLabel")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("booking_priority_label");
                    ...
                    b.Property<DateTime?>("DecisionEvaluatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("decision_evaluated_at");
                    ...
                    b.Property<string>("ReviewBadge")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("review_badge");

                    b.Property<string>("ReviewExplanation")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                        .HasColumnName("review_explanation");
            ...
            modelBuilder.Entity("CafeReservation.Domain.Entities.Tenant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("CafeReservation.Domain.Entities.Feedback", b =>
                {
                    b.HasOne("CafeReservation.Domain.Entities.Tenant", "Tenant")
                        .WithMany("Feedbacks")
            ...
            modelBuilder.Entity("CafeReservation.Domain.Entities.Tenant", b =>
                {
                    ...
                    b.Navigation("RestaurantInfos");

                    b.Navigation("Reviews");

                    b.Navigation("SeatingAreas");
